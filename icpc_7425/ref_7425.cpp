      ...
      for (int j = i + 1; j < m; ++j) {
        if (pipes[i].first != pipes[j].first) {
          if (SegmentsIntersect(pipes[i].first, pipes[i].second,
            ...
            // cout << pipes[i].first.x << "," << pipes[i].first.y;
            // cout << "---" << pipes[i].second.x << "," << pipes[i].second.y;
            // cout << " X " << pipes[j].first.x << "," << pipes[j].first.y;
            // cout << "---" << pipes[j].second.x << "," << pipes[j].second.y << endl;
